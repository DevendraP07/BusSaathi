...
export function Sidebar({ role, userName, userEmail }: SidebarProps) {
	...
	return (
		<aside className="flex h-full w-60 flex-col bg-[oklch(0.14_0.03_250)] text-sidebar-foreground">
			{/* Brand */}
			<div className="flex items-center gap-3 border-sidebar-border border-b px-4 py-5">
